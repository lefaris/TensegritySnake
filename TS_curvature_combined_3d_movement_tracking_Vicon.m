...
figure(2)
[uhat, vhat, what, origin] = movement(E1(1,:), E2(1,:), E3(1,:), final_row);
rotation1 = [uhat'; what'; vhat'];
translation1 = origin;
transformation1 = [rotation1, translation1; 0,0,0,1];

plotCurvatureEndpoints(351, "#C7A491", E1, E2, E3)
% Calculate frame based off orthonormal basis vectors
[uhat, vhat, what, origin] = movement(E1(351,:), E2(351,:), E3(351,:), final_row);
...
plotCurvatureEndpoints(1261, "#EECFCA", E1, E2, E3)
% Calculate frame based off orthonormal basis vectors
[uhat, vhat, what, origin] = movement(E1(1261,:), E2(1261,:), E3(1261,:), final_row);
rotation2 = [uhat'; what'; vhat'];
translation2 = origin;
transformation2 = [rotation2, translation2; 0,0,0,1];
T_rel = inv(transformation2)*transformation1;
...
plotCurvatureEndpoints(2401, "#997B66", E1, E2, E3)
% Calculate frame based off orthonormal basis vectors
[uhat, vhat, what, origin] = movement(E1(2401,:), E2(2401,:), E3(2401,:), final_row);
rotation2 = [uhat'; what'; vhat'];
translation2 = origin;
transformation2 = [rotation2, translation2; 0,0,0,1];
T_rel = inv(transformation2)*transformation1;
...
plotCurvatureEndpoints(3191, "#919682", E1, E2, E3)
% Calculate frame based off orthonormal basis vectors
[uhat, vhat, what, origin] = movement(E1(3191,:), E2(3191,:), E3(3191,:), final_row);
rotation2 = [uhat'; what'; vhat'];
translation2 = origin;
transformation2 = [rotation2, translation2; 0,0,0,1];
T_rel = inv(transformation2)*transformation1;
...
plotCurvatureEndpoints(4331, "#C7CDBF", E1, E2, E3)
% Calculate frame based off orthonormal basis vectors
[uhat, vhat, what, origin] = movement(E1(4331,:), E2(4331,:), E3(4331,:), final_row);
rotation2 = [uhat'; what'; vhat'];
translation2 = origin;
transformation2 = [rotation2, translation2; 0,0,0,1];
T_rel = inv(transformation2)*transformation1;
...
plotCurvatureEndpoints(5271, "#595E48", E1, E2, E3)
% Calculate frame based off orthonormal basis vectors
[uhat, vhat, what, origin] = movement(E1(5271,:), E2(5271,:), E3(5271,:), final_row);
rotation2 = [uhat'; what'; vhat'];
translation2 = origin;
transformation2 = [rotation2, translation2; 0,0,0,1];
T_rel = inv(transformation2)*transformation1;
...
quiver3(origin(1), origin(2), origin(3), what(1), what(2), what(3), q_scale, 'b', 'LineWidth', 5, 'MaxHeadSize', 2);
hold on
% legend('Motor 1', 'Motor 2', 'Motor 3', 'Motors 1 + 3', 'Motors 1 + 2', 'Motors 2 + 3')
