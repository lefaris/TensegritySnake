...
% % Generate video info
% video_title = "full_inchworm_tracking.mp4"; %Update with descriptive title and make sure not to overwrite previous video
...
for i = [1, 3780] % Plot starting and ending full robot configurations
    ...
    if i == 3780
        ...
        % Display Results
        fprintf('Relative Translation: [%.2f, %.2f, %.2f]\n', t_rel);
        fprintf('Relative Euler Angles (deg): [%.2f, %.2f, %.2f]\n', euler_rel);
